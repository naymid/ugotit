        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-400">
              <li><a href="#" className="hover:text-amber-500 transition-colors">Two Wheels</a></li>
              <li><a href="#" className="hover:text-amber-500 transition-colors">Three Wheels</a></li>
